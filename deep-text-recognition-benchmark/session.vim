...
silent only
cd /home/text_recog/deep-text-recognition-benchmark
...
badd +3 demo.py
badd +0 dataset.py
badd +6 modules/prediction.py
badd +0 modules/sequence_modeling.py
argglobal
silent! argdel *
$argadd .
set stal=2
...
silent! normal! zE
let s:l = 42 - ((30 * winheight(0) + 21) / 43)
...
wincmd w
argglobal
if bufexists('modules/sequence_modeling.py') | buffer modules/sequence_modeling.py | else | edit modules/sequence_modeling.py | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
